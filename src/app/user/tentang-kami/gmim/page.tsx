...
import BgUser from "../../../../assets/img/bg-ohio.jpeg";

export default function gmim() {
  return (
    <div className="bg-11">
      {" "}
      <div
        // style={{ backgroundImage: `url(${BgUser})` }}
        className="flex justify-center bg-gradient-to-r from-slate-100 to-slate-500 items-center bg-auto bg-center bg-fixed py-24"
      >
        <h1 className="text-3xl max-md:text-xl text-black text-center poppins-thin animate-fade-in">
          Sejarah Terbentuknya Gereja Masehi Injili di Minahasa
        </h1>
      </div>
      <div className="px-[10%] pb-10">
        <ul className="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical">
          <li>
            ...
            <div className="timeline-start mb-10 md:text-end animate-slide-in-left">
          ...
          <li>
            ...
            <div className="timeline-end mb-10 animate-slide-in-right">
